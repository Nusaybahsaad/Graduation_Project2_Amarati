...
class _SplashPageState extends State<SplashPage> {
  ...
  void initState() {
    super.initState();
    // Simulate initial loading to show the splash briefly
  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthBloc, AuthState>(
      listener: (context, state) {
        // Only navigate if we've passed the initial delay
        // We handle immediate state resolution here just in case it takes longer than 2 seconds
        _navigateBasedOnState(state);
      },
      child: Scaffold(
        body: Stack(
